...
for rejected in failed-run pull-request-run branch-run implicit-rebuild source-test-missing-sha source-test-nonmain source-test-rebuild source-test-on-runtime automated-source-test; do
  case "$rejected" in
