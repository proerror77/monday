...
use hft_live::deployment_envelope::{
    ActivationMode, ActivationRequest, RuntimeActivationAdapter, SystemConfigActivationAdapter,
};
...
fn production_config_accepts_the_governed_paper_target() {
    ...
    let request = ActivationRequest {
        ...
        asset_revision_id: "asset-1".to_string(),
    ...
    SystemConfigActivationAdapter::new(&mut config)
        .activate(&request)
