...
use criterion::{
    ...
    measurement::WallTime, Measurement
};
                    ...
                    for _i in 0..iters {
                        for update in &updates {
                            ...
                            for bid in &update.bids {
                                orderbook.update_level(Side::Bid, bid.price, bid.quantity).unwrap();
                            }
                            for ask in &update.asks {
                                orderbook.update_level(Side::Ask, ask.price, ask.quantity).unwrap();
                            }
            ...
            |b, &ops_target| {
                ...
                b.iter(|| {
                    ...
                    while operations < ops_target {
                        ...
                        orderbook.update_level(Side::Bid, bid_price, quantity).unwrap();
                        orderbook.update_level(Side::Ask, ask_price, quantity).unwrap();
        ...
        group.bench_with_input(
            ...
            |b, &data_size| {
                ...
                let prices: Vec<f64> = (0..data_size)
                    ...
                    .collect();
                let quantities: Vec<f64> = (0..data_size)
