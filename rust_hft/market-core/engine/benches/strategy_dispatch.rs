...
impl Strategy for MockStrategy {
    fn on_market_event(
        ...
        vec![OrderIntent {
            ...
            price: Some(Price::from_f64(10_000.0).expect("valid price")),
...
fn bench_boxed_strategy_dispatch(c: &mut Criterion) {
    ...
    c.bench_function("strategy_dispatch_box_dyn", |b| {
        b.iter(|| {
...
criterion_group!(benches, bench_boxed_strategy_dispatch);
