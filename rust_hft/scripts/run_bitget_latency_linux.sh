...
QUEUE_KIND="${QUEUE_KIND:-spsc-spin}"
...
IDLE_TIMEOUT_US="${IDLE_TIMEOUT_US:-50}"
...

{
  ...
  echo "idle_timeout_us=${IDLE_TIMEOUT_US}"
...
args=(
  ...
  --idle-timeout-us "$IDLE_TIMEOUT_US"
...
echo "  queue kind:    ${QUEUE_KIND}"
echo "  idle timeout:  ${IDLE_TIMEOUT_US}us"
