# Contributing to Monday's prediction-market module

PLOY is developed inside Monday at `rust_hft/prediction-markets`. Follow the Monday root
`CLAUDE.md`, `rust_hft/prediction-markets/AGENTS.md`, and
`docs/architecture/PREDICTION_MARKETS.md` before changing architecture or runtime
boundaries.
