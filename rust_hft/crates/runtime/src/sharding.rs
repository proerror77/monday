...
mod tests {
    ...
    fn test_shard_strategy_from_str() {
        assert_eq!(ShardStrategy::from("symbol-hash"), ShardStrategy::SymbolHash);
        assert_eq!(ShardStrategy::from("venue-round-robin"), ShardStrategy::VenueRoundRobin);
    ...
    fn test_venue_round_robin_sharding() {
        ...
        let bitget = VenueId::from("BITGET");
    ...
    fn test_shard_distribution() {
        ...
        for symbol_str in &test_symbols {
            ...
            for shard_idx in 0..shard_count {
                let config = ShardConfig::new(shard_idx as u32, shard_count as u32, ShardStrategy::SymbolHash);
        ...
        assert!(max_count - min_count <= 1, "Shard distribution too uneven: {:?}", shard_counts);
    }
}