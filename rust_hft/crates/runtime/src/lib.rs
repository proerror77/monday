...
mod tests {
    ...
    fn test_system_builder_smoke() {
        ...
        let _builder = builder
            .register_market_stream_plan(VenueType::Bitget, vec![Symbol("BTCUSDT".to_string())]);
    }
...
"#;
        ...
        assert!(start_result.is_ok(), "系統啟動失敗: {:?}", start_result.err());
...
"#;
        ...
        assert!(builder_result.is_ok(), "SystemBuilder::from_yaml 失敗: {:?}", builder_result.err());
