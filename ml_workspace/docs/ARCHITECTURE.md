...
This is a migration/reference architecture for Python research code. It does not own the production control plane, promotion, runtime configuration, risk, OMS, or execution. The canonical system architecture is [`../../rust_hft/ARCHITECTURE.md`](../../rust_hft/ARCHITECTURE.md).
...
- Python artifacts cannot enter governed promotion until equivalent point-in-time lineage, deterministic evaluation, and typed Rust bundle validation exist.
