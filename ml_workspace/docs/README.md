# Legacy Python Research Documentation

This documentation describes prototype Python workflows. It is not the current production architecture. See [`../../rust_hft/ARCHITECTURE.md`](../../rust_hft/ARCHITECTURE.md) for the bounded Loop Engineer and runtime trust boundaries.
...
- Prototype output is not promotable without governed Rust lineage and evaluation.
