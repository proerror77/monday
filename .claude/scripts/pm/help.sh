...
echo "============================================="
echo ""
echo "GitHub Issues are authoritative."
echo "Local mirrors are optional authoring context, never issue state."
echo ""
...
echo ""
echo "📝 Issue Commands"
echo "  /pm:issue-show <num>      - Display live issue state and relationships"
echo "  /pm:issue-status <num>    - Check live GitHub status"
...
echo "  /pm:status             - Show live GitHub issue counts"
