...
and (.state_recovery_markets | type == "number" and floor == . and . >= 0)
and (.state_recovery_markets <= .target_markets)
...
and (.market_detail_budget == ([.trade_poll_budget, .trade_poll_concurrency] | min))
