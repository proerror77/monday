...
grep -Fq 'systemctl_prop "${unit[$market]}" DropInPaths' "$SOAK"
grep -Fq 'systemctl_prop "${unit[$market]}" OOMScoreAdjust' "$SOAK"
grep -Fq 'systemctl_prop "${unit[$market]}" MemoryHigh' "$SOAK"
grep -Fq 'systemctl_prop "${unit[$market]}" MemoryMax' "$SOAK"
grep -Fq '== 1879048192' "$SOAK"
grep -Fq '== 2147483648' "$SOAK"
...
grep -Fq -- '--property=OOMScoreAdjust=500' "$PREFLIGHT"
grep -Fq -- '--property=MemoryHigh=2560M' "$PREFLIGHT"
grep -Fq -- '--property=MemoryMax=3072M' "$PREFLIGHT"
