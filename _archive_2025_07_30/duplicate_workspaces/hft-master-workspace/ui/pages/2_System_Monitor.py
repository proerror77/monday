...
async def header():
    st.markdown("<h1 class='heading'>📊 System Monitor</h1>", unsafe_allow_html=True)
    st.markdown(
        "<p class='subheading'>Real-time monitoring agent for system health and performance analysis.</p>",
...
async def body() -> None:
    ...
    ####################################################################
    user_id = st.sidebar.text_input(":technologist: Username", value="HFT-Monitor")
    ...
    if (
        ...
        logger.info("---*--- Creating System Monitor Agent ---*---")
