...
5. Read the final external artifact or service independently. A publish command or healthy process is not readback.
...
- **Readback**: an independent query observes the expected terminal output or service behavior.
